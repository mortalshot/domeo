 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".guarantee__slider")) new Swiper(".guarantee__slider", {
            ...
            if (document.querySelector(".awards__slider")) new Swiper(".awards__slider", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.3,
...
***************************************************************************** */
        ...
        document.addEventListener("DOMContentLoaded", (function() {
                    ...
                    options.forEach((button => {
                        button.addEventListener("change", (function() {
                            ...
                            if (nextStep && nextStep.classList.contains("quiz__step")) {
                                ...
                                if (nextStep.classList.contains("quiz__step_full")) nextStep.closest(".quiz__grid").classList.add("_full"); else nextStep.closest(".quiz__grid").classList.remove("_full");
            ...
            if (inputWrappers.length > 0) inputWrappers.forEach((item => {
